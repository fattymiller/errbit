...
send :ruby, ENV['GEMFILE_RUBY_VERSION'] || '2.2.4'
...
gem 'errbit_jira_engine', github: 'fattymiller/errbit_jira_engine'
gem 'errbit_errorception_engine', github: 'fattymiller/errbit_errorception_engine'
...
gem 'omniauth-jira', github: 'fattymiller/omniauth-jira', branch: 'expose-jira-authorisation-keys'
